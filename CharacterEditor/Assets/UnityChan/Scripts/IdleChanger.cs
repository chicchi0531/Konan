...
// Require these components when using this script
	...
	public class IdleChanger : MonoBehaviour
	{
		...
		void OnGUI ()
		{
			GUI.Box (new Rect (Screen.width - mGUIPosX, 10, 100, 90), "Change Motion");
			if (GUI.Button (new Rect (Screen.width - mGUIPosX-10, 40, 80, 20), "Next"))
				anim.SetBool ("Next", true);
			if (GUI.Button (new Rect (Screen.width - mGUIPosX -10, 70, 80, 20), "Back"))
				anim.SetBool ("Back", true);
		}
