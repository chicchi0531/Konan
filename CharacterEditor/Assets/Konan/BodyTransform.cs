...
public class BodyTransform : MonoBehaviour {
	...
	public void OnChange () {
        ...
        //親を変形
        mTop.localScale = new Vector3(sittingRate, (1.0f-sittingRate)*0.5f + sittingRate, (1.0f - sittingRate) * 0.5f + sittingRate);
        ...
        mRightLeg.localScale = new Vector3(bottomRate, bottomRate, bottomRate);
        mLeftLeg.localScale = new Vector3(bottomRate, bottomRate, bottomRate);
	}
}
